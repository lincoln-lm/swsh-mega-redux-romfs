...
void main() { do
{
    ...
    temp_4 = in_attr1.z;
    temp_5 = in_attr1.x;
    temp_6 = clamp(fma(1.0 / fma(texture(sysDepthBufferTexture, vec2(in_attr3.x * _sysCustomShaderUniformBlock1.data[1].x * temp_0, in_attr3.y * _sysCustomShaderUniformBlock1.data[1].y * temp_0)).x, _sysViewUniformBlock.data[18].w, 0.0 - _sysViewUniformBlock.data[18].y), 0.0 - _sysViewUniformBlock.data[18].z, 0.0 - 1.0 / fma(in_attr3.z * temp_0, _sysViewUniformBlock.data[18].w, 0.0 - _sysViewUniformBlock.data[18].y) * 0.0 - _sysViewUniformBlock.data[18].z) * (1.0 / _sysEmitterStaticUniformBlock.data[95].y), 0.0, 1.0) * clamp(temp_2 * in_attr0.w, 0.0, 1.0) * in_attr4.x;
    ...
    temp_9 = fma(temp_2, 0.0 - temp_5 + in_attr0.x, temp_5);
    temp_10 = fma(temp_1.y, 0.0 - temp_3 + in_attr0.y, temp_3);
    if (temp_7)
    {
        temp_8 = 0;
    }
    temp_11 = fma(temp_1.z, 0.0 - temp_4 + in_attr0.z, temp_4);
    if (temp_7)
    {
