...
void main() { do
{
    ...
    temp_114 = fma(temp_108, 0.0 - temp_113, 0.5);
    temp_115 = fma(temp_105, temp_113, 0.5);
    temp_116 = 1.0 / _sysEmitterStaticUniformBlock.data[48].z * _sysEmitterStaticUniformBlock.data[48].x;
    temp_117 = 1.0 / _sysEmitterStaticUniformBlock.data[48].w * _sysEmitterStaticUniformBlock.data[48].y;
    temp_118 = temp_115;
    temp_119 = temp_114;
