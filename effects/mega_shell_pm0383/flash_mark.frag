...
void main() { do
{
    ...
    temp_1 = in_attr1.x;
    temp_2 = temp_0.x * temp_0.x;
    temp_3 = in_attr1.z;
    temp_4 = clamp(temp_2 * in_attr4.w * in_attr0.w, 0.0, 1.0) * in_attr3.x;
    temp_5 = in_attr1.y;
    ...
    temp_10 = fma(temp_0.y * temp_0.y, 0.0 - temp_5 + in_attr0.y, temp_5);
    temp_11 = fma(temp_2, 0.0 - temp_1 + in_attr0.x, temp_1) * in_attr4.x;
    temp_12 = floatBitsToInt(temp_10);
    if (temp_6)
    {
        temp_7 = 0;
    }
    ...
    temp_14 = fma(temp_0.z * temp_0.z, 0.0 - temp_3 + in_attr0.z, temp_3) * in_attr4.z;
    sysOutputColor0 = vec4(temp_11, temp_13, temp_14, temp_4);
} while (false);
}
