...
void main() { do
{
    ...
    temp_1 = in_attr4.y;
    temp_2 = texture(sysTextureSampler2, vec2(in_attr3.x, in_attr3.y)).xyzw;
    ...
    temp_5 = in_attr0.y;
    temp_6 = in_attr1.z;
    temp_7 = clamp(temp_2.w * temp_3.w * in_attr5.w * in_attr0.w, 0.0, 1.0) * in_attr4.x;
    temp_8 = in_attr1.y;
    temp_9 = temp_7 <= _sysEmitterStaticUniformBlock.data[94].z;
    temp_10 = floatBitsToInt(temp_5);
    temp_11 = floatBitsToInt(temp_8);
    temp_12 = floatBitsToInt(1.0 / gl_FragCoord.w);
    if (temp_9)
    {
        discard;
    }
    temp_13 = temp_2.z * temp_3.z;
    temp_14 = floatBitsToInt(temp_13);
    if (temp_9)
    {
        temp_10 = 0;
    }
    ...
    temp_15 = fma(temp_2.x * temp_3.x, 0.0 - temp_4 + in_attr0.x, temp_4) * in_attr5.x;
    temp_16 = fma(temp_2.y * temp_3.y, 0.0 - temp_8 + temp_5, temp_8) * in_attr5.y;
    if (temp_9)
    {
        temp_14 = 0;
    }
    if (temp_9)
    {
        ...
        sysOutputColor0.z = intBitsToFloat(temp_12);
        sysOutputColor0.w = intBitsToFloat(temp_10);
        break;
    }
    temp_17 = fma(temp_13, 0.0 - temp_6 + in_attr0.z, temp_6) * in_attr5.z;
    sysOutputColor0 = vec4(temp_15, temp_16, temp_17, temp_7);
} while (false);
}
