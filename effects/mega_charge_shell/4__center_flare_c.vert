...
void main() { do
{
    ...
    temp_73 = 1.0 / (0.0 - _sysEmitterStaticUniformBlock.data[60].w + _sysEmitterStaticUniformBlock.data[61].w);
    temp_74 = 1.0 / (_sysEmitterStaticUniformBlock.data[62].w + 0.0 - _sysEmitterStaticUniformBlock.data[61].w);
    temp_75 = temp_72 >= _sysEmitterStaticUniformBlock.data[60].w ? 1.0 : 0.0;
    temp_76 = temp_72 + 0.0 - _sysEmitterStaticUniformBlock.data[61].w;
    temp_77 = temp_72 >= _sysEmitterStaticUniformBlock.data[61].w ? 1.0 : 0.0;
    temp_78 = temp_72 >= _sysEmitterStaticUniformBlock.data[62].w ? 1.0 : 0.0;
    temp_79 = temp_72 + 0.0 - _sysEmitterStaticUniformBlock.data[60].w;
    temp_80 = fma(temp_75, 0.0 - temp_77, temp_75);
    temp_81 = fma(temp_77, 0.0 - temp_78, temp_77);
    if (0.0 < _sysEmitterStaticUniformBlock.data[8].y)
    {
        temp_82 = fma(temp_10 * _sysEmitterStaticUniformBlock.data[9].z, _sysEmitterStaticUniformBlock.data[8].y, temp_5) * (1.0 / _sysEmitterStaticUniformBlock.data[8].y);
    ...
    temp_84 = sysRandomAttr.y;
    temp_85 = sysRandomAttr.z;
    temp_86 = (1 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].y)) != 1;
    temp_87 = int(trunc(_sysEmitterStaticUniformBlock.data[58].z));
    temp_88 = int(trunc(_sysEmitterStaticUniformBlock.data[53].z));
    temp_89 = temp_83 >= _sysEmitterStaticUniformBlock.data[68].w ? 1.0 : 0.0;
    temp_90 = sysTexCoordAttr.x;
    temp_91 = sysTexCoordAttr.y;
    temp_92 = temp_83 >= _sysEmitterStaticUniformBlock.data[69].w ? 1.0 : 0.0;
    temp_93 = 0;
    temp_94 = temp_85;
    temp_95 = temp_10;
    temp_96 = temp_84;
    ...
    temp_98 = temp_83 >= _sysEmitterStaticUniformBlock.data[70].w ? 1.0 : 0.0;
    temp_99 = floatBitsToInt(1.0 / float(uint(temp_87))) + -2;
    temp_100 = floatBitsToInt(1.0 / float(uint(abs(temp_87)))) + -2;
    temp_101 = temp_90;
    if (!(((!((0x800000 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].x)) == floatBitsToInt(1.1754944E-38)) || !(temp_84 > 0.5) ? -1 : 0)) != 0))
    {
        temp_101 = 0.0 - temp_90 + 1.0;
    }
    temp_102 = floatBitsToInt(1.0 / float(uint(temp_88))) + -2;
    temp_103 = floatBitsToInt(1.0 / float(uint(abs(temp_88)))) + -2;
    temp_104 = temp_93 == 1;
    temp_105 = temp_83 >= _sysEmitterStaticUniformBlock.data[71].w ? 1.0 : 0.0;
    temp_106 = temp_90;
    temp_107 = temp_90;
    if (!(((!((0x80000 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].x)) == floatBitsToInt(7.34684E-40)) || !(temp_10 > 0.5) ? -1 : 0)) != 0))
    {
        temp_106 = 0.0 - temp_90 + 1.0;
    }
    if (!(((!((0x200000 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].x)) == floatBitsToInt(2.938736E-39)) || !(temp_85 > 0.5) ? -1 : 0)) != 0))
    {
        temp_107 = 0.0 - temp_90 + 1.0;
    }
    temp_108 = uint(max(trunc(float(0u) * intBitsToFloat(temp_102)), 0.0));
    temp_109 = uint(max(trunc(float(0u) * intBitsToFloat(temp_99)), 0.0));
    temp_110 = uint(max(trunc(intBitsToFloat(temp_103) * float(0u)), 0.0));
    temp_111 = uint(max(trunc(float(0u) * intBitsToFloat(temp_100)), 0.0));
    temp_112 = temp_10;
    temp_113 = temp_84;
    if (temp_104)
    {
    ...
    temp_124 = (temp_88 & 0xFFFF) * (int(temp_108 >> 16)) & 0xFFFF | int(temp_108) << 16;
    temp_125 = (temp_87 & 0xFFFF) * (int(temp_109 >> 16)) & 0xFFFF | int(temp_109) << 16;
    temp_126 = 0;
    if (temp_86)
    {
        temp_126 = 2;
    }
    temp_127 = (abs(temp_88) & 0xFFFF) * (int(temp_110 >> 16)) & 0xFFFF | int(temp_110) << 16;
    temp_128 = (abs(temp_87) & 0xFFFF) * (int(temp_111 >> 16)) & 0xFFFF | int(temp_111) << 16;
    temp_129 = temp_126 == 1;
    temp_130 = temp_10;
    temp_131 = temp_84;
    temp_132 = temp_10;
    ...
    temp_142 = int(temp_108) + int(uint(max(trunc(intBitsToFloat(temp_102) * float(uint(0 - ((int(uint(temp_88) >> 16)) * (int(uint(temp_124) >> 16)) << 16) + (temp_88 & 0xFFFF) * (int(temp_108) & 0xFFFF) + (temp_124 << 16)))), 0.0)));
    temp_143 = int(temp_109) + int(uint(max(trunc(intBitsToFloat(temp_99) * float(uint(0 - ((int(uint(temp_87) >> 16)) * (int(uint(temp_125) >> 16)) << 16) + (temp_87 & 0xFFFF) * (int(temp_109) & 0xFFFF) + (temp_125 << 16)))), 0.0)));
    temp_144 = int(temp_110) + int(uint(max(trunc(intBitsToFloat(temp_103) * float(uint(0 - ((int(uint(abs(temp_88)) >> 16)) * (int(uint(temp_127) >> 16)) << 16) + (abs(temp_88) & 0xFFFF) * (int(temp_110) & 0xFFFF) + (temp_127 << 16)))), 0.0)));
    temp_145 = (temp_88 & 0xFFFF) * (int(uint(temp_142) >> 16)) & 0xFFFF | temp_142 << 16;
    temp_146 = int(temp_111) + int(uint(max(trunc(intBitsToFloat(temp_100) * float(uint(0 - ((int(uint(abs(temp_87)) >> 16)) * (int(uint(temp_128) >> 16)) << 16) + (abs(temp_87) & 0xFFFF) * (int(temp_111) & 0xFFFF) + (temp_128 << 16)))), 0.0)));
    temp_147 = (temp_87 & 0xFFFF) * (int(uint(temp_143) >> 16)) & 0xFFFF | temp_143 << 16;
    temp_148 = (abs(temp_88) & 0xFFFF) * (int(uint(temp_144) >> 16)) & 0xFFFF | temp_144 << 16;
    temp_149 = (abs(temp_87) & 0xFFFF) * (int(uint(temp_146) >> 16)) & 0xFFFF | temp_146 << 16;
    temp_150 = 0 - temp_142 + ((uint(0 - ((int(uint(temp_88) >> 16)) * (int(uint(temp_145) >> 16)) << 16) + (temp_88 & 0xFFFF) * (temp_142 & 0xFFFF) + (temp_145 << 16)) >= uint(temp_88) ? -1 : 0));
    temp_151 = 0 - temp_143 + ((uint(0 - ((int(uint(temp_87) >> 16)) * (int(uint(temp_147) >> 16)) << 16) + (temp_87 & 0xFFFF) * (temp_143 & 0xFFFF) + (temp_147 << 16)) >= uint(temp_87) ? -1 : 0));
    temp_152 = (temp_88 & 0xFFFF) * (int(uint(temp_150) >> 16)) & 0xFFFF | temp_150 << 16;
    temp_153 = (temp_87 & 0xFFFF) * (int(uint(temp_151) >> 16)) & 0xFFFF | temp_151 << 16;
    temp_154 = 0 - int(uint(temp_87) >> 31);
    temp_155 = 1.0 / _sysEmitterStaticUniformBlock.data[53].z * _sysEmitterStaticUniformBlock.data[53].x;
    temp_156 = 1.0 / _sysEmitterStaticUniformBlock.data[53].w * _sysEmitterStaticUniformBlock.data[53].y;
    temp_157 = temp_91;
    if (!(((!((0x400000 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].x)) == floatBitsToInt(5.877472E-39)) || !(sysRandomAttr.w > 0.5) ? -1 : 0)) != 0))
    {
        temp_157 = 0.0 - temp_91 + 1.0;
    }
    temp_158 = 0 - int(uint(temp_88) >> 31);
    temp_159 = fma(temp_155, temp_107, -0.5);
    temp_160 = 0.0 - fma(temp_5, _sysEmitterStaticUniformBlock.data[52].x, fma(temp_119, _sysEmitterStaticUniformBlock.data[52].z, _sysEmitterStaticUniformBlock.data[52].z + _sysEmitterStaticUniformBlock.data[52].y));
    temp_161 = fma(temp_156, temp_157, -0.5);
    out_attr6.x = sysVertexColor0Attr.x;
    temp_162 = 1.0 / _sysEmitterStaticUniformBlock.data[58].z * _sysEmitterStaticUniformBlock.data[58].x;
    out_attr6.y = sysVertexColor0Attr.y;
    out_attr6.z = sysVertexColor0Attr.z;
    temp_163 = 1.0 / _sysEmitterStaticUniformBlock.data[58].w * _sysEmitterStaticUniformBlock.data[58].y;
    temp_164 = temp_91;
    if (!(((!((0x1000000 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].x)) == floatBitsToInt(2.3509887E-38)) || !(temp_85 > 0.5) ? -1 : 0)) != 0))
    {
        temp_164 = 0.0 - temp_91 + 1.0;
    }
    out_attr6.w = sysVertexColor0Attr.w;
    if (!(((!((0x100000 & floatBitsToInt(_sysEmitterStaticUniformBlock.data[5].x)) == floatBitsToInt(1.469368E-39)) || !(temp_84 > 0.5) ? -1 : 0)) != 0))
    {
        temp_97 = 0.0 - temp_91 + 1.0;
    }
    ...
    out_attr0.x = fma(temp_78, _sysEmitterStaticUniformBlock.data[62].x, fma(fma((_sysEmitterStaticUniformBlock.data[62].x + 0.0 - _sysEmitterStaticUniformBlock.data[61].x) * temp_74, temp_76, _sysEmitterStaticUniformBlock.data[61].x), temp_81, fma(fma(temp_79, (_sysEmitterStaticUniformBlock.data[61].x + 0.0 - _sysEmitterStaticUniformBlock.data[60].x) * temp_73, _sysEmitterStaticUniformBlock.data[60].x), temp_80, fma(temp_75, 0.0 - _sysEmitterStaticUniformBlock.data[60].x, _sysEmitterStaticUniformBlock.data[60].x)))) * _sysEmitterDynamicUniformBlock.data[0].x * _sysEmitterStaticUniformBlock.data[59].x;
    out_attr0.y = fma(temp_78, _sysEmitterStaticUniformBlock.data[62].y, fma(fma((_sysEmitterStaticUniformBlock.data[62].y + 0.0 - _sysEmitterStaticUniformBlock.data[61].y) * temp_74, temp_76, _sysEmitterStaticUniformBlock.data[61].y), temp_81, fma(fma(temp_79, (_sysEmitterStaticUniformBlock.data[61].y + 0.0 - _sysEmitterStaticUniformBlock.data[60].y) * temp_73, _sysEmitterStaticUniformBlock.data[60].y), temp_80, fma(temp_75, 0.0 - _sysEmitterStaticUniformBlock.data[60].y, _sysEmitterStaticUniformBlock.data[60].y)))) * _sysEmitterDynamicUniformBlock.data[0].y * _sysEmitterStaticUniformBlock.data[59].x;
    out_attr0.z = fma(temp_78, _sysEmitterStaticUniformBlock.data[62].z, fma(fma((_sysEmitterStaticUniformBlock.data[62].z + 0.0 - _sysEmitterStaticUniformBlock.data[61].z) * temp_74, temp_76, _sysEmitterStaticUniformBlock.data[61].z), temp_81, fma(fma(temp_79, (_sysEmitterStaticUniformBlock.data[61].z + 0.0 - _sysEmitterStaticUniformBlock.data[60].z) * temp_73, _sysEmitterStaticUniformBlock.data[60].z), temp_80, fma(temp_75, 0.0 - _sysEmitterStaticUniformBlock.data[60].z, _sysEmitterStaticUniformBlock.data[60].z)))) * _sysEmitterDynamicUniformBlock.data[0].z * _sysEmitterStaticUniformBlock.data[59].x;
    out_attr0.w = fma(temp_105, _sysEmitterStaticUniformBlock.data[71].x, fma(fma((0.0 - _sysEmitterStaticUniformBlock.data[70].x + _sysEmitterStaticUniformBlock.data[71].x) * (1.0 / (0.0 - _sysEmitterStaticUniformBlock.data[70].w + _sysEmitterStaticUniformBlock.data[71].w)), temp_83 + 0.0 - _sysEmitterStaticUniformBlock.data[70].w, _sysEmitterStaticUniformBlock.data[70].x), fma(temp_98, 0.0 - temp_105, temp_98), fma(fma((_sysEmitterStaticUniformBlock.data[70].x + 0.0 - _sysEmitterStaticUniformBlock.data[69].x) * (1.0 / (_sysEmitterStaticUniformBlock.data[70].w + 0.0 - _sysEmitterStaticUniformBlock.data[69].w)), temp_83 + 0.0 - _sysEmitterStaticUniformBlock.data[69].w, _sysEmitterStaticUniformBlock.data[69].x), fma(temp_92, 0.0 - temp_98, temp_92), fma(fma((0.0 - _sysEmitterStaticUniformBlock.data[68].x + _sysEmitterStaticUniformBlock.data[69].x) * (1.0 / (0.0 - _sysEmitterStaticUniformBlock.data[68].w + _sysEmitterStaticUniformBlock.data[69].w)), temp_83 + 0.0 - _sysEmitterStaticUniformBlock.data[68].w, _sysEmitterStaticUniformBlock.data[68].x), fma(temp_92, 0.0 - temp_89, temp_89), fma(temp_89, 0.0 - _sysEmitterStaticUniformBlock.data[68].x, _sysEmitterStaticUniformBlock.data[68].x))))) * _sysEmitterDynamicUniformBlock.data[0].w;
    out_attr2.x = temp_106 * _sysEmitterStaticUniformBlock.data[48].x * (1.0 / _sysEmitterStaticUniformBlock.data[48].z);
    out_attr2.y = temp_97 * _sysEmitterStaticUniformBlock.data[48].y * (1.0 / _sysEmitterStaticUniformBlock.data[48].w);
    out_attr2.z = fma(fma(cos(temp_160), temp_159, 0.0 - temp_161 * sin(temp_160)), fma(temp_5, _sysEmitterStaticUniformBlock.data[50].z, fma(temp_121, _sysEmitterStaticUniformBlock.data[51].z, _sysEmitterStaticUniformBlock.data[51].z + _sysEmitterStaticUniformBlock.data[51].x)), fma(temp_155, float(temp_88 < 0 || !(temp_88 == 0) ? ((int(uint(temp_88) >> 16)) * (int(uint(temp_152) >> 16)) << 16) + (temp_88 & 0xFFFF) * (temp_150 & 0xFFFF) + (temp_152 << 16) : -1), fma(temp_5, 0.0 - _sysEmitterStaticUniformBlock.data[49].x, 0.0 - fma(temp_115 * _sysEmitterStaticUniformBlock.data[50].x, -2.0, _sysEmitterStaticUniformBlock.data[50].x + _sysEmitterStaticUniformBlock.data[49].z)))) + 0.5;
    out_attr2.w = fma(fma(temp_159, sin(temp_160), temp_161 * cos(temp_160)), fma(temp_5, _sysEmitterStaticUniformBlock.data[50].w, fma(temp_122, _sysEmitterStaticUniformBlock.data[51].w, _sysEmitterStaticUniformBlock.data[51].y + _sysEmitterStaticUniformBlock.data[51].w)), 0.0 - fma(temp_156, 0.0 - float(temp_88 < 0 || !(temp_88 == 0) ? 0 - temp_158 + (temp_144 + 0 - (uint(0 - ((int(uint(abs(temp_88)) >> 16)) * (int(uint(temp_148) >> 16)) << 16) + (abs(temp_88) & 0xFFFF) * (temp_144 & 0xFFFF) + (temp_148 << 16)) >= uint(abs(temp_88)) ? -1 : 0) ^ temp_158) : -1), fma(temp_5, _sysEmitterStaticUniformBlock.data[49].y, fma(temp_117 * _sysEmitterStaticUniformBlock.data[50].y, -2.0, _sysEmitterStaticUniformBlock.data[50].y + _sysEmitterStaticUniformBlock.data[49].w)))) + 0.5;
    out_attr3.x = fma(fma(temp_5, _sysEmitterStaticUniformBlock.data[55].z, fma(temp_139, _sysEmitterStaticUniformBlock.data[56].z, _sysEmitterStaticUniformBlock.data[56].x + _sysEmitterStaticUniformBlock.data[56].z)), fma(temp_162, temp_101, -0.5), fma(temp_162, float(temp_87 < 0 || !(temp_87 == 0) ? ((int(uint(temp_87) >> 16)) * (int(uint(temp_153) >> 16)) << 16) + (temp_87 & 0xFFFF) * (temp_151 & 0xFFFF) + (temp_153 << 16) : -1), fma(temp_5, 0.0 - _sysEmitterStaticUniformBlock.data[54].x, 0.0 - fma(temp_134 * _sysEmitterStaticUniformBlock.data[55].x, -2.0, _sysEmitterStaticUniformBlock.data[55].x + _sysEmitterStaticUniformBlock.data[54].z)))) + 0.5;
    out_attr3.y = fma(fma(temp_5, _sysEmitterStaticUniformBlock.data[55].w, fma(temp_140, _sysEmitterStaticUniformBlock.data[56].w, _sysEmitterStaticUniformBlock.data[56].w + _sysEmitterStaticUniformBlock.data[56].y)), fma(temp_163, temp_164, -0.5), 0.0 - fma(temp_163, 0.0 - float(temp_87 < 0 || !(temp_87 == 0) ? 0 - temp_154 + (temp_146 + 0 - (uint(0 - ((int(uint(abs(temp_87)) >> 16)) * (int(uint(temp_149) >> 16)) << 16) + (abs(temp_87) & 0xFFFF) * (temp_146 & 0xFFFF) + (temp_149 << 16)) >= uint(abs(temp_87)) ? -1 : 0) ^ temp_154) : -1), fma(temp_5, _sysEmitterStaticUniformBlock.data[54].y, fma(temp_136 * _sysEmitterStaticUniformBlock.data[55].y, -2.0, _sysEmitterStaticUniformBlock.data[55].y + _sysEmitterStaticUniformBlock.data[54].w)))) + 0.5;
    break;
} while (false);
}
